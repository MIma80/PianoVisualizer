...
namespace Piano
{
    internal class PianoKeys
    {
        ...
        public PianoKeys(int width, int height)
        {
        ...
        public void CreateKeys(Panel panel)
        {
            for (int i = 0, j = 0; i < 36; i++, j++)
            {
                ...
                blackKey.MouseLeave += backState;
                blackKey.MouseEnter += (sender, e) => foo(sender, e, panel);
            ...
            for (int i = 0; i < 52; i++)
            {
                ...
                whiteKey.MouseEnter += (sender, e) => foo(sender, e, panel);
                whiteKey.MouseLeave += backState;
                //
